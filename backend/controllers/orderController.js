...
//     // Add Cashfree payment IDs if available
//     if (paymentResponse && paymentResponse.order_id) {
//       orderData.cashfreeOrderId = paymentResponse.order_id;
//     }
//     if (paymentResponse && paymentResponse.payment_id) {
//       orderData.cashfreePaymentId = paymentResponse.payment_id;
//     }
...
export const createOrder = async (req, res) => {
  try {
    ...
    // ✅ ONLY CASHFREE PAYMENT IDS - NO RAZORPAY
    if (paymentResponse && paymentResponse.order_id) {
      orderData.cashfreeOrderId = paymentResponse.order_id;
    }
    if (paymentResponse && paymentResponse.payment_id) {
    ...
    if (paymentResponse && paymentResponse.cf_payment_id) {
      orderData.cashfreePaymentId = paymentResponse.cf_payment_id;
    }
